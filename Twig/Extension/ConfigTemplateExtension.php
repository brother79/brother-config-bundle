...
namespace Brother\ConfigBundle\Twig\Extension;

use Brother\ConfigBundle\Util\Config;
...
class ConfigTemplateExtension extends \Twig_Extension {
	...
	public function getName() {
		return 'brother_config_template';
	}
	...
	public function getFilters() {
		return array(
			new \Twig_SimpleFilter('brother_sortSections', array($this, 'sortSections')),
		);
	}
	...
	public function getFunctions() {
		return array(
			new \Twig_SimpleFunction('brother_setting', array($this, 'getSetting')),
		);
	}
