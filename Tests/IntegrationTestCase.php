...
Brother\ConfigBundle\dle\Twig\Extension\ConfigTemplateExtensionBrother\ConfigBundle\undle\Util\Config;
...
abstract class IntegrationTestCase extends WebTestCase {
	...
	protected function getConfig() {
		return $this->getService('brother_config');
	}
	...
	protected function getConfigTemplateExtension() {
		return $this->getService('twig.extension.brother_config_template');
	}
