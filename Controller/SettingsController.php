		...
		if ($request->getMethod() === 'POST') {
			...
			if ($form->isValid()) {
				...
				$this->get('session')->getFlashBag()->set('notice',
						$this->get('translator')->trans('settings_changed', array(), 'BrotherConfigBundle'));
				return $this->redirect($this->generateUrl($this->container->getParameter('brother_config.redirectRouteAfterModify')));
			}
		}

		return $this->render('BrotherConfigBundle:Settings:modify.html.twig', array(
